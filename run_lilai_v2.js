// 精确复刻 fsaf.html analyze() 行为 — 跑利来全部数据
const fs = require('fs');

// ===== 复制 fsaf.html 的全部解析函数 (819行起) =====
const ZODIAC_MAP = {
